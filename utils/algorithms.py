...
def cost_edit_path(g1: nx.Graph, g2: nx.Graph, sg1, sg2, path):
    """
...
def unprocessed_cost(g1, g2, sg1, sg2):
    """
...
def beam_search(graph1, graph2, beamsize):
    ...
    for v in pending_v:
        ...
        total_cost = cost_edit_path(g1, g2, sg1, sg2, edit_path) + unprocessed_cost(g1, g2, sg1, sg2)
        ...
        if not unprocessed_u and not unprocessed_v:
            ...
            if unprocessed_u:
                ...
                for v_next in unprocessed_v:
                    ...
                    total_cost = cost_edit_path(g1, g2, sg1, sg2, new_path) + unprocessed_cost(g1, g2, sg1, sg2)
...
# 1. DF_GED
# t1 = time.time()
# paths, ged = DF_GED(graph1, graph2)
# t2 = time.time()
# print(paths, ged)
# print(t2 - t1)
